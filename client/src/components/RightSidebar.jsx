...
setMsgImages(
  ...
  return  selectedUser && (
    <div className={`bg-[#8185b2]/10 text-white w-full relative overflo-y-scroll ${selectedUser ? "max-md:hidden" :""}`}>


      <div  className='pt-16 flex flex-col items-center gap-2 text-xs ont-light mx-auto'>
